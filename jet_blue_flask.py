...
def results(target_flights):
	...
	for flight in flight_list:
		s1 += "\tFrom {} to {} on {} with a score of {} | Price: ${} + Tax: ${}<br/>".format(flight[1],
	...
	for flight in flight_list_2:
		s1 += "\tFrom {} to {} on {} with a score of {} | Points from fare: {} + Points from tax: {}<br/>".format(flight[1],
	...
	for flight in flight_list_4:
		s1 += "\tFrom {} to {} on with a score: {} | Points from fare: {} + Points from tax: {}<br/>".format(flight[1],
			flight[2], flight[3], flight[6], flight[9], flight[10])
	results.append(s1)
